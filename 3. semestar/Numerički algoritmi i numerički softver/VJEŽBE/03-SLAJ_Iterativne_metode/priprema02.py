import numpy as np
from priprema01 import jacobi


def gauss_seidel(A, b, x_0, err_max=0.01, iter_max=200):
    ...
    for i in range(iter_max):
        for r in range(rows):
            x[r] = 1/A[r, r]*(b[r]-np.dot(A[r, :r], x[:r])-np.dot(A[r, r+1:], x_0[r+1:]))
...
if __name__ == '__main__':
    ...
    x, it = gauss_seidel(A, b, x_0, 1e-05, 100)
    print("\n=== Gauss-Seidel ===")
    print("Rješenje: ", np.round(x, 2))
    print("Broj iteracija: ", it)
    print("Apsolutna greška: ", abs(xt - x))

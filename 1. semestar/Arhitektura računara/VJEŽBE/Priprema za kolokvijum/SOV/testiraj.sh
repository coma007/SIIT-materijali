...
OUTP01=$(cat <<EOL
Unseite logicki izraz: 0xff & 35 ^ 0x67 | 11
Rezultat:  117
EOL
)
...
OUTP02=$(cat <<EOL
Unseite logicki izraz: 1 | 2 ^ 33 & 4 | 5 ^ 66 | 7
Rezultat:  107
EOL
)
...
OUTP03=$(cat <<EOL
Unseite logicki izraz: 1 | 2 | 4 | 8 | 16 | 32 | 64 | 128
Rezultat:  377
EOL
)
...
OUTP04=$(cat <<EOL
Unseite logicki izraz: 0xa5 ^ 0xa5 ^ 0xa5 ^ 0xa5 ^ 0xa5 ^ 0xa5 ^ 0xa5 ^ 0xa5 ^ 0xa5
Rezultat:  245
EOL
)
...
OUTP05=$(cat <<EOL
Unseite logicki izraz: 255 & 0xfe & 253 & 0xFB & 247
Rezultat:  360
EOL
)
...
OUTP06=$(cat <<EOL
Unseite logicki izraz: 255 & 0xfe & 256 & 0xFB & 247
Greska kod operanda.
EOL
)
...
OUTP07=$(cat <<EOL
Unseite logicki izraz: 255 & 0xfe & 255 & 0xFB & 2f
Greska kod operanda.
EOL
)
...
OUTP08=$(cat <<EOL
Unseite logicki izraz: 123 | 45 1 67 ^ 0x58

...
Prvi string ima vise malih slova nego drugi.
EOL
)
...
Drugi string ima vise malih slova od prvog.
EOL
)
...
OUTP03=$(cat <<EOL
Unesite prvi string: VELIKA SLOVA
Unesite drugi string: JOS VELIKIH SLOVA
Oba stringa imaju isti broj malih slova.
EOL
)
...
OUTP04=$(cat <<EOL
Unesite prvi string: mala slova
Unesite drugi string: qwertyuio
Oba stringa imaju isti broj malih slova.
EOL
)

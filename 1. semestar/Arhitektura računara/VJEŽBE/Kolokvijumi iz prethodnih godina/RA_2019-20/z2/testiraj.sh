...
OUTP03=$(cat <<EOL
Unesite izvorne znakove: abcdef
Unesite ciljne znakove: ghijkl
Unesite string za enkodovanje: The quick brown fox jumps over the lazy dog

String nakod enkodovanja : Thk quiik hrown lox jumps ovkr thk lgzy jog
Povratna vrednost: 8
EOL
)

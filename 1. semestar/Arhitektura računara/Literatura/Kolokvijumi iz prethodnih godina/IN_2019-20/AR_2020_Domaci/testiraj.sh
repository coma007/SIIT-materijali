...
TEST02=$(cat <<EOL
12345678abc ovde nema 32bitnih brojeva!    
EOL
)
...
Unesite string: Trla baba lan da joj prodje dan...
Zbir: BB94
EOL
)

TEST04=$(cat <<EOL
     12345678   abcdefab 1234CDEF     7890ABCD         
EOL
)

OUTP04=$(cat <<EOL
Unesite string:      12345678   abcdefab 1234CDEF     7890ABCD         
Zbir: 148C7BFDF
EOL
)
...
OUTP05=$(cat <<EOL
Unesite string:      ffffffff   FFFFFFFF FfFfFfFf     FFFFffff     fFfFfFfF    
Zbir: 4FFFFFFFB
EOL
)

TEST06=$(cat <<EOL
 3497856139048657193485679178 abedcfeadcfeadbfceadbfceadfceadc
EOL
)

OUTP06=$(cat <<EOL
Unesite string:  3497856139048657193485679178 abedcfeadcfeadbfceadbfceadfceadc
Nema 32-bitnih hex brojeva.
EOL
)

TEST07=$(cat <<EOL
#!(*%23^!*(#&()!#345*%^!)&@(adbc#^!*(@&#)aeef\$*()!@#&%\$*f(!@&\$(e)!*@&!\$a@&b%\$*()!&@r%\$*()!@&%^4!!!1
EOL
)

OUTP07=$(cat <<EOL
Unesite string: #!(*%23^!*(#&()!#345*%^!)&@(adbc#^!*(@&#)aeef\$*()!@#&%\$*f(!@&\$(e)!*@&!\$a@&b%\$*()!&@r%\$*()!@&%^4!!!1
Zbir: 1604A
EOL
)
